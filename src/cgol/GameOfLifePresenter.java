...
public class GameOfLifePresenter {
     ...
     */
    public GameOfLifePresenter(final GameOfLifeView view, String fileName, int centX, int centY) {
        if (view == null) {
        ...
        GameOfLifePatterns initialPattern = new GameOfLifePatterns(currentGeneration);

        initialPattern.readPatternFromFile(fileName, centX, centY);
